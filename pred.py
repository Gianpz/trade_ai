...
# Argomenti
parser = argparse.ArgumentParser(description="Prevedi i prezzi con un modello specificato")
parser.add_argument("model_path", type=str, help="Percorso del modello salvato (es. model_williams_5_80.h5)")
parser.add_argument("--w_len", type=int, default=20, help="Williams%R length (opzionale)")
parser.add_argument("--a_len", type=int, default=14, help="ATR length (opzionale)")
